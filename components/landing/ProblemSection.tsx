    ...
    <section id="problem" className="py-24 px-6 bg-[#08080a] border-y border-zinc-900">
      <div className="max-w-6xl mx-auto">
        <div className="text-center mb-16">
          <span className="text-[11px] font-mono text-[#ff6b35]/60 uppercase tracking-[0.3em] block mb-3">THE PROBLEM</span>
        ...
        <div className="grid md:grid-cols-3 gap-6">
          ...
          <motion.div
            ...
            className="group"
          >
            <div className="bg-[#111113] border border-zinc-800 p-6 rounded-2xl transition-all hover:border-zinc-755 h-full flex flex-col justify-between">
              <div>
                <div className="flex items-center gap-4 mb-4">
                  <div className="w-10 h-10 rounded-xl bg-orange-500/10 border border-orange-500/20 flex items-center justify-center font-mono font-bold text-orange-500 text-sm">
                    1
                  </div>
