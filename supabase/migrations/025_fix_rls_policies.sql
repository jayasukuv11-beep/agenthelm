...
-- Fix agent_handoffs: remove permissive policy
DROP POLICY IF EXISTS "Service role manages handoffs" ON agent_handoffs;
DROP POLICY IF EXISTS "service_role_handoffs" ON agent_handoffs;
