      ...
      <Card className="w-full max-w-md bg-paper-card border-line rounded-2xl shadow-sm">
        ...
        <CardContent>
          <form onSubmit={handleSendOtp} className="space-y-4">
            <div className="space-y-3">
              <Label htmlFor="email" className="text-[12px] font-semibold text-ink block text-left">Email Address</Label>
              <Input
                id="email"
                type="email"
                ...
                required
                className="bg-paper border-line text-ink rounded-xl h-12 px-4 focus-visible:ring-2 focus-visible:ring-vermilion/40 focus-visible:border-vermilion transition-all"
                disabled={loading || success || cooldown > 0}
              />
            </div>
            {error && <p className="text-[12px] text-red-600 text-left bg-red-500/10 p-2 border border-red-500/30 rounded-lg">{error}</p>}
            {success && <p className="text-[12px] font-semibold text-moss text-left bg-moss-soft p-2 border border-moss/30 rounded-lg">Check your email for the code! Redirecting...</p>}
          ...
          <div className="relative my-8">
            ...
            <div className="relative flex justify-center text-[11px] font-medium">
              <span className="bg-paper-card px-4 text-muted">Or continue with</span>
            </div>
          </div>
          ...
          <Button
            type="button"
            variant="outline"
            className="w-full border-line text-ink-soft hover:bg-paper-dim hover:text-ink rounded-xl h-12 text-[13px] font-semibold transition-all"
          ...
          <Button
            type="button"
            variant="outline"
            className="w-full border-line text-ink-soft hover:bg-paper-dim hover:text-ink rounded-xl h-12 text-[13px] font-semibold transition-all mt-3"
        ...
        <CardFooter className="flex flex-col items-center gap-4 pt-2 pb-6">
          ...
          <div className="flex justify-center gap-4 text-[11px] text-muted">
            <a href="/privacy-policy" className="hover:text-vermilion transition-colors">Privacy</a>
            <span>·</span>
            <a href="/terms-of-service" className="hover:text-vermilion transition-colors">Terms</a>
            <span>·</span>
            <a href="/refund-policy" className="hover:text-vermilion transition-colors">Refunds</a>
          </div>
        </CardFooter>
      </Card>
    </div>
