  ...
  return (
    <div className="space-y-12 pb-12">
      ...
      <div className="relative overflow-hidden rounded-none bg-[#111] border border-zinc-800 p-8 md:p-12 mb-12">
        ...
        <div className="absolute top-0 right-0 -mr-20 -mt-20 w-96 h-96 bg-indigo-500/5 blur-3xl opacity-50" />
      </div>

      {/* Quick Start Card */}
      <section className="space-y-6">
        <div className="flex items-center gap-3">
          <div className="p-2 bg-indigo-500/10 border border-indigo-500/20 rounded-none">
        ...
        <div className="grid md:grid-cols-2 gap-6">
          <div className="bg-[#111] border border-zinc-800 rounded-none p-6 space-y-4 shadow-sm">
            <div className="flex items-center justify-between">
              <span className="text-[11px] font-mono uppercase tracking-widest font-bold text-indigo-400">Python SDK v0.3.0</span>
          ...
          <div className="bg-[#111] border border-zinc-800 rounded-none p-6 space-y-4 shadow-sm">
            <div className="flex items-center justify-between">
              <span className="text-[11px] font-mono uppercase tracking-widest font-bold text-indigo-400">Node.js SDK v0.4.0</span>
              <Code2 className="w-4 h-4 text-zinc-500" />
            </div>
            <code className="block bg-[#0a0a0a] p-4 rounded-none border border-zinc-800 text-[13px] text-zinc-300 font-mono">
        ...
        <div className="bg-[#111] border border-zinc-800 rounded-none p-8">
          <div className="grid md:grid-cols-4 gap-8">
            <div className="space-y-3">
              <div className="w-10 h-10 border border-indigo-500/30 bg-indigo-500/10 rounded-none flex items-center justify-center">
                <span className="text-[12px] font-mono font-bold text-indigo-400">1</span>
              </div>
            ...
            <div className="space-y-3">
              <div className="w-10 h-10 border border-indigo-500/30 bg-indigo-500/10 rounded-none flex items-center justify-center">
                <span className="text-[12px] font-mono font-bold text-indigo-400">2</span>
              </div>
            ...
            <div className="space-y-3">
              <div className="w-10 h-10 border border-indigo-500/30 bg-indigo-500/10 rounded-none flex items-center justify-center">
                <span className="text-[12px] font-mono font-bold text-indigo-400">3</span>
              </div>
            ...
            <div className="space-y-3">
              <div className="w-10 h-10 border border-indigo-500/30 bg-indigo-500/10 rounded-none flex items-center justify-center">
                <span className="text-[12px] font-mono font-bold text-indigo-400">4</span>
              </div>
          ...
          <table className="w-full text-left font-mono text-[12px] uppercase">
            ...
            <tbody className="divide-y divide-zinc-800 text-zinc-400 tracking-wider">
              <tr className="hover:bg-[#151515] transition-colors">
                <td className="px-6 py-4 font-bold text-indigo-400">/status</td>
                <td className="px-6 py-4 text-center"><BarChart2 className="w-4 h-4 text-indigo-400 mx-auto" /></td>
                <td className="px-6 py-4">See current agent progress, token usage, and last checkpoint.</td>
              </tr>
              <tr className="hover:bg-[#151515] transition-colors">
                <td className="px-6 py-4 font-bold text-indigo-400">/logs</td>
                <td className="px-6 py-4 text-center"><ClipboardList className="w-4 h-4 text-indigo-400 mx-auto" /></td>
                <td className="px-6 py-4">View the last 5 logs from your active agent session.</td>
              </tr>
              <tr className="hover:bg-[#151515] transition-colors">
                <td className="px-6 py-4 font-bold text-indigo-400">/run [name]</td>
                <td className="px-6 py-4 text-center"><Play className="w-4 h-4 text-emerald-400 mx-auto" /></td>
                <td className="px-6 py-4">Start a specific agent or launch your primary stack.</td>
              </tr>
              <tr className="hover:bg-[#151515] transition-colors">
                <td className="px-6 py-4 font-bold text-indigo-400">/stop [name]</td>
                <td className="px-6 py-4 text-center"><Square className="w-4 h-4 text-red-400 mx-auto" /></td>
                <td className="px-6 py-4">Safely stop an agent via a "Confirm Stop" interactive button.</td>
              </tr>
              <tr className="hover:bg-[#151515] transition-colors">
                <td className="px-6 py-4 font-bold text-indigo-400">/resume</td>
                <td className="px-6 py-4 text-center"><Rocket className="w-4 h-4 text-indigo-400 mx-auto" /></td>
                <td className="px-6 py-4">Restart a task from the last valid checkpoint using SHA256 validation.</td>
              </tr>
              <tr className="hover:bg-[#151515] transition-colors">
                <td className="px-6 py-4 font-bold text-indigo-400">/credits</td>
                <td className="px-6 py-4 text-center"><CreditCard className="w-4 h-4 text-indigo-400 mx-auto" /></td>
                <td className="px-6 py-4">Check your monthly token limits and current consumption.</td>
              </tr>
              <tr className="hover:bg-[#151515] transition-colors">
                <td className="px-6 py-4 font-bold text-indigo-400">Intl Keyboards</td>
                <td className="px-6 py-4 text-center"><CheckCircle2 className="w-4 h-4 text-emerald-400 mx-auto" /></td>
      ...
      <section className="grid md:grid-cols-2 gap-8">
        <div className="bg-[#111] border border-zinc-800 rounded-none p-8 space-y-4 hover:border-zinc-700 transition-colors shadow-sm">
          ...
          <p className="text-zinc-500 font-mono text-[12px] uppercase leading-relaxed tracking-wider">
            ...
            Indian users see <code className="text-indigo-300">INR (₹)</code> while international 
            users use <code className="text-indigo-300">USD ($)</code>.
          </p>
        </div>
        ...
        <div className="bg-[#111] border border-zinc-800 rounded-none p-8 space-y-4 hover:border-zinc-700 transition-colors shadow-sm">
          ...
          <p className="text-zinc-500 font-mono text-[12px] uppercase leading-relaxed tracking-wider">
            The platform is now machine-readable via <code className="text-indigo-300">llms.txt</code>. 
        ...
        <div className="bg-[#111] border border-zinc-800 rounded-none p-8 space-y-4 hover:border-zinc-700 transition-colors shadow-sm md:col-span-2">
          ...
          <p className="text-zinc-500 font-mono text-[12px] uppercase leading-relaxed tracking-wider">
            AgentHelm now features a full, trace-connected Eval engine powered by <code className="text-indigo-300">Gemini 2.5 Flash</code>. 
      ...
      <section className="grid md:grid-cols-2 gap-8">
        <div className="bg-[#111] border border-zinc-800 rounded-none p-8 space-y-4 shadow-sm">
          ...
          <p className="text-zinc-500 font-mono text-[12px] uppercase leading-relaxed tracking-wider">
            Every checkpoint includes a <code className="text-indigo-300">state_hash</code> (SHA256). 
      ...
      <div className="pt-8 border-t border-zinc-800 flex flex-col items-center justify-center text-center space-y-4 mt-8">
        ...
        <p className="text-zinc-500 font-mono text-[12px] uppercase tracking-wider max-w-md">
          ...
          <span className="text-indigo-400 ml-1 cursor-pointer hover:underline">tharagesharumugam@gmail.com</span>
        </p>
      </div>
    </div>
  );
