  ...
  return (
    <LegalPage title="Privacy Policy" lastUpdated="March 24, 2026">
      ...
      <section>
        ...
        <p>
          We collect information that you and your connected agents provide to us when you register, use our SDKs/MCP server, 
        ...
        <ul className="list-disc pl-6 space-y-2">
          ...
          <li><strong>Agent Telemetry & Logs:</strong> Real-time log messages, level alerts (info, warning, error, success), task execution progress, structured outputs, and LLM token usage (models and counts).</li>
          <li><strong>Code-Derived Project Metadata:</strong> Knowledge proposals, schema definitions, API contracts, architectural standards, and system decisions generated by or submitted via connected agents.</li>
          <li><strong>Execution Traces & Checkpoints:</strong> Sequential step traces, tool execution logs, agent checkpoints (including state integrity hashes), and reasoning/intervention histories.</li>
        </ul>
      </section>
